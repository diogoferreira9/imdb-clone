...
public class Queries {
    ...
    public static Result countMoviesBetweenYearsWithNActors(String yearStart, String yearEnd, String min, String max) {
        ...
        for (Ator a : Main.atorArrayList) {
            ...
            atoresPorFilme
                    .computeIfAbsent(a.getMovieId(), k -> new HashSet<>())
                    .add(nomeNormalizado);
        }
    ...
    public static Result distanceBetweenActors(String args) {
        ...
        for (Ator a : Main.atorArrayList) {
            ...
            atorParaFilmes.computeIfAbsent(actorId, k -> new HashSet<>()).add(movieId);
            filmeParaAtores.computeIfAbsent(movieId, k -> new HashSet<>()).add(actorId);
